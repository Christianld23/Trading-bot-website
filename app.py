...
# Page configuration
st.set_page_config(
    page_title="Capital Allocator Dashboard",
    page_icon="💰",
    layout="wide"
)
...
# Function to get crypto price from CoinGecko
...
if 'data_loaded' not in st.session_state:
    ...
    if loaded_data:
        ...
        st.session_state.long_term_pct = 40
        st.session_state.swing_trades_pct = 30
        st.session_state.real_estate_pct = 30
